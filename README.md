CP1 - MS2 Source Code - Basic Payroll Program (Group 14 - H1101)
...
Open in IDE: Open the root folder in NetBeans, IntelliJ, or VS Code.

CSV Location: Ensure Employee Database.csv and Employee Attendance Record.csv remain inside the src/ folder.

Compile & Run: Execute MO_IT101_Group14.java.
